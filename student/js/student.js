...
export const Student = {
    ...
    // 🔧 FIX: saveProfile - এখন profileCompleted সঠিকভাবে সেট হয়
    saveProfile: async () => {
        ...
        try {
            ...
            // Firebase-এ প্রোফাইল আপডেট (profileCompleted: true)
    ...
    loadMockHub: async () => {
        ...
        if (!navigator.onLine) {
            ...
            if (!offlineCached) {
                c.innerHTML = renderHeader('dashboard') + `<div class="p-10 text-center" style="color:var(--text-muted);"><i class="fas fa-wifi-slash text-4xl mb-3 opacity-30"></i><p>অফলাইন মোডে মক পরীক্ষার তথ্য পাওয়া যায়নি।</p><p class="text-xs mt-2">ইন্টারনেট সংযোগ করে একবার লোড করুন।</p></div>`;
                return;
            }
        }
